...
#SBATCH --output=iqtree_gene_trees_with_codon_MFP_%j.out # 中文注释：标准输出文件
#SBATCH --error=iqtree_gene_trees_with_codon_MFP_%j.err  # 中文注释：标准错误文件
...
INPUT_DIR="./DAS_aligned_codon_clipkit"
